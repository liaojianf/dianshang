...
public class T_MALL_ORDER_INFO {
	...
	public void setSku_mch(String sku_mch) throws UnsupportedEncodingException {
		this.sku_mch = new String(sku_mch.getBytes("ISO8859-1"), "utf-8");
	}
	...
	public void setSku_kcdz(String sku_kcdz) throws UnsupportedEncodingException {
		this.sku_kcdz = new String(sku_kcdz.getBytes("ISO8859-1"), "utf-8");
	}
